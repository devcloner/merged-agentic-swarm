...
## Connections
- [[dot-__init__()_14]] - `references` [EXTRACTED]
- [[dot-test_batch_parallel_custom_ramp_clamped_and_bounded()]] - `calls` [EXTRACTED]
- [[dot-test_custom_config()]] - `calls` [EXTRACTED]
- [[dot-test_default_allocations()]] - `calls` [EXTRACTED]
- [[dot-test_get_available_worker_fallback_to_core_engineer()]] - `calls` [EXTRACTED]
...
- [[agentic_cli.py]] - `imports` [EXTRACTED]
- [[cmd_config()]] - `calls` [EXTRACTED]
